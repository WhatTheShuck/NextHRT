...
import { TicketRecords } from "@/generated/prisma_client/client";
    ...
    header: ({ column }) => {
      return (
        <Button
          ...
          onClick={() => column.toggleSorting(column.getIsSorted() === "asc")}
        >
          Ticket Name <ArrowUpDown className="ml-2 h-4 w-4" />
        </Button>
      );
    },
    accessorKey: "ticket.ticketName",
    meta: {
    ...
    header: ({ column }) => {
      return (
        <Button
          ...
          onClick={() => column.toggleSorting(column.getIsSorted() === "asc")}
        >
          Ticket Code <ArrowUpDown className="ml-2 h-4 w-4" />
        </Button>
      );
    },
    accessorKey: "ticket.ticketCode",
    meta: {
